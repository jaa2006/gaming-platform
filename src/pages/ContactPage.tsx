      ...
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-center text-foreground/70 mb-12 max-w-2xl mx-auto">
            Have questions or feedback? Our team is here to help you with any inquiries about our AI chat service.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="valorant-card text-center">
              ...
              <a href="mailto:support@aiduel.com" className="text-accent hover:text-accent-hover font-medium">
                support@aiduel.com
              </a>
            </div>
            ...
            <div className="valorant-card text-center">
              ...
              <a href="tel:+15551234567" className="text-accent hover:text-accent-hover font-medium">
                +1 (555) 123-4567
              </a>
            </div>
          ...
          <div className="valorant-card">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <label className="font-medium flex items-center mb-2">
                  <MessageSquare size={16} className="text-accent mr-2" />
                  SUBJECT
                </label>
                <select
                  name="subject"
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  className="valorant-input w-full min-h-[150px]"
          ...
          <div className="mt-12 valorant-card">
            <h2 className="text-2xl font-bold mb-4 border-l-4 border-accent pl-4">
              CONNECT WITH US
            </h2>
